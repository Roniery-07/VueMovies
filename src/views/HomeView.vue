  ...
  <div class="home">
    <div class="featured-card">
      <router-link to="/movie/tt0409591">
        <picture>
          <source media="(min-width: 30em)" srcset="../assets/naruto-poster-high.jpg" width="900" height="563">
        ...
        <div class="detail">
          <h3>Naruto</h3>
          <p>Naruto is a orphan that has a monster inside him</p>
        </div>        
      </router-link>
    </div>
...
.home{
  ...
  .movies-list{
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(175px, 1fr)); /* Número de colunas flexível */
    gap: 16px;
